...
lint:
	$(PY) -m flake8 src mazegenerator-00001-py3-none-any *.py
	$(PY) -m mypy src mazegenerator-00001-py3-none-any *.py --warn-return-any --warn-unused-ignores --ignore-missing-imports --disallow-untyped-defs --check-untyped-defs

# Optional stricter type check: flake8 plus mypy in full --strict mode.
lint-strict:
	$(PY) -m flake8 src mazegenerator-00001-py3-none-any *.py
	$(PY) -m mypy src mazegenerator-00001-py3-none-any *.py --strict
